...
class ImageGenerateRequest(BaseModel):
    """
    [씠誘몄 깮꽦 二쇰Ц꽌]
    ControlNet 벑 깮꽦 AI 紐⑤뜽뿉寃 씠誘몄 빀꽦쓣 슂泥븯뒗 二쇰Ц꽌엯땲떎.
    """
    session_id: str = Field("session_default", description="궗슜옄 옉뾽 꽭뀡 ID")
    prompt: str = Field(..., description="깮꽦븯怨 떢 씠誘몄 꽕紐 湲 (삁: A modern street graffiti art)")
    style: Optional[str] = Field("realistic", description="뒪씪 샃뀡 (삁: realistic, anime 벑)")
